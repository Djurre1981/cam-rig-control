/*
 * Cam Rig Uno — 4-axis velocity jog firmware (CNC Shield V3)
 ...
 *
 * Shield wiring:
 *   X=boom  Y=swing  Z=yaw  A=pitch
 *   Enable D8 (shared) | Boom min D9 (X-) | Boom max D10 (Y-)
 */
...
void setupEnable() {
  ...
  digitalWrite(ENABLE_PIN, LOW);  // active LOW = all drivers enabled
}
